...
isn't *more* documentation — it's documentation that **doesn't drift**, because
drift quietly erodes trust in every other line.
...
|---|---|---|---|
| **Intent** | *Why* the code is the way it is | a load-bearing constraint, a trade-off, a rejected alternative, a boundary's rationale | **Maximize.** This is what docs are *for*, and it barely drifts — intent outlives implementation. |
...
- The **trade-off** taken and the alternative rejected — this is the most
  valuable and most drift-proof thing a doc can carry.
